...
public unsafe partial struct CharaViewPortrait : ICreatable
{
    ...
    */
    ...
    [MemberFunction("E8 ?? ?? ?? ?? 0F B7 43 10 48 8D 54 24 ??")]
    ...
    [MemberFunction("E8 ?? ?? ?? ?? 0F B6 45 92 38 45 02")]
...
public unsafe partial struct CompressedVector4
{
    ...
    public void Compress(System.Numerics.Vector3 vec)
    {
        Compress(vec.X, vec.Y, vec.Z);
    }

    public void Compress(System.Numerics.Vector4 vec)
    {
        Compress(vec.X, vec.Y, vec.Z, vec.W);
    }
}
